...
class Headers extends MY_Admin {
	private $_template 			= 'template_admin/main';
	private $_module_controller = 'backend_headers/headers/';
	private $_table_name 		= 'header';
	private $_table_field_pref 	= 'head_';
	private $_table_pk 			= 'head_id_header';
	private $_model_crud 		= 'headers_model';
	...
	private function get_show_column() {
		$column_list = array(
			array(
				...
				'field_name' 			=> $this->_table_field_pref . 'id_header',
				'show_no_static' 		=> true,
				'no_order'				=> 0,
			),
			array(
				'title_header_column' 	=> 'Header',
				'field_name' 			=> $this->_table_field_pref . 'text_header',
				'no_order'				=> 1,
			),
			array(
	...
	private function get_input_field_new($data_value = array()) {
		$data_input = array(
			array(
				'db_field' 		=> $this->_table_field_pref . 'id_header',
				'db_pk' 		=> true,
				'db_process'	=> false,
				'data_edit'		=> array(
					'db_process'		=> false,

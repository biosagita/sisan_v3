				...
				'child'	=> array(
					...
					array(
						...
						'child'	=> array(
                            ...
                            array(
                                'label' => 'Permasalahan',
                                'url_link' => site_url('backend_permasalahan/permasalahan/page_content_ajax'),
                                'icon' => '<i class="glyph-icon icon-linecons-diamond"></i>',
                            ),
						),
					),
					array(
						...
						'child'	=> array(
                            ...
                            array(
                                'label' => 'Schedule',
                                'url_link' => site_url('backend_schedules/schedules/page_content_ajax'),
                                'icon' => '<i class="glyph-icon icon-linecons-diamond"></i>',
                            ),
						),
					),
					...
					array(
						...
						'child'	=> array(
							...
							array(
								'label' => 'Permasalahan',
								'url_link' => site_url('report_permasalahan/permasalahan/page_content_ajax'),
                                'icon' => '<i class="glyph-icon icon-linecons-diamond"></i>',
							),
						),
					),

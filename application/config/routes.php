...
$route['default_controller'] = "counter_loketdestination/loketdestination";

$route['counter'] = "counter_loket/loket";
$route['counter/login'] = "counter_login/login";

$route['loketdestination'] = "counter_loketdestination/loketdestination";
$route['changeloket'] = "counter_changeloket/changeloket";

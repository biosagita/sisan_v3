...
class Permasalahan extends MY_Admin {
	...
	private $_module_controller = 'report_permasalahan/permasalahan/';
	private $_table_name 		= 'transaksi_log';
	private $_table_field_pref 	= 'trans_';
	private $_table_pk 			= 'trans_id_transaksi';
	private $_model_crud 		= 'reportpermasalahan_model';

	private $_page_title 		= 'Antrian : Admin Laporan Permasalahan';
	private $_page_content_info	= array(
		'title' => 'Data Admin Laporan Permasalahan',
		'desc' 	=> 'List laporan Permasalahan',
	);
	...
	function page_export_excel() {
		$filename = 'antrian_permasalahan_' . str_replace('-', '', date('Y-m-d')) . '.xls';

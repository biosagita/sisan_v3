...
class Visitor extends MY_Admin {
	...
	function lists_ajax_filter() {
		...
		$this->_data['trans_tipe_antrian'] = $this->input->post('trans_tipe_antrian');
	...
	function page_export_text() {
        ...
        if(!empty($_GET['trans_tipe_antrian'])) {
            $where[] = 'trans_tipe_antrian = ' . $_GET['trans_tipe_antrian'];
        }

...
class Alldetail extends MY_Admin {
	...
	private $_page_title 		= 'Antrian : Admin Laporan All Detail';
	private $_page_content_info	= array(
		'title' => 'Data Admin Laporan All Detail',
		'desc' 	=> 'List laporan all detail',
	);
	...
	function page_export_text() {
		...
		JOIN `t_master_profile` tmp ON `trans_id_profile` = `id_profile`

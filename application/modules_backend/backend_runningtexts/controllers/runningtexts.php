...
class Runningtexts extends MY_Admin {
	private $_template 			= 'template_admin/main';
	private $_module_controller = 'backend_runningtexts/runningtexts/';
	private $_table_name 		= 'running_text';
	private $_table_field_pref 	= 'runtex_';
	private $_table_pk 			= 'runtex_id_running_text';
	private $_model_crud 		= 'runningtexts_model';

	private $_page_title 		= 'Antrian : Admin Running Text';
	private $_page_content_info	= array(
		'title' => 'Data Running Text',
		'desc' 	=> 'List Running Text',
	);
	...
	private function get_show_column() {
		$column_list = array(
			array(
				...
				'field_name' 			=> $this->_table_field_pref . 'id_running_text',
				'show_no_static' 		=> true,
				'no_order'				=> 0,
			),
			array(
				'title_header_column' 	=> 'Text',
				'field_name' 			=> $this->_table_field_pref . 'text',
				'no_order'				=> 1,
			),
			array(
	...
	private function get_input_field_new($data_value = array()) {
		$data_input = array(
			array(
				'db_field' 		=> $this->_table_field_pref . 'id_running_text',
				'db_pk' 		=> true,
				'db_process'	=> false,
				'data_edit'		=> array(
					'db_process'		=> false,
			...
			array(
				'label' 		=> 'Created Date',
				'db_field' 		=> $this->_table_field_pref . 'created_date',
				'db_process'	=> true,
				'input_type'	=> 'text',
				'input_attr'	=> 'type="text" class="form-control" placeholder="Created Date..."',
				'data_source'	=> '',
				'data_edit'		=> array(
					'db_process'	=> true,
				),
			...
			array(
				'label' 		=> 'Modified Date',
				'db_field' 		=> $this->_table_field_pref . 'modified_date',
				'db_process'	=> true,
				'input_type'	=> 'text',
				'input_attr'	=> 'type="text" class="form-control" placeholder="Modified Date..."',
				'data_source'	=> '',
				'data_edit'		=> array(
					'db_process'	=> true,
				),
			...
			array(
				'label' 		=> 'Start Date',
				'db_field' 		=> $this->_table_field_pref . 'start_date',
				'db_process'	=> true,
				'input_type'	=> 'text',
				'input_attr'	=> 'type="text" class="form-control" placeholder="Start Date..."',
				'data_source'	=> '',
				'data_edit'		=> array(
					'db_process'	=> true,
				),
			...
			array(
				'label' 		=> 'Expired Date',
				'db_field' 		=> $this->_table_field_pref . 'expired_date',
				'db_process'	=> true,
				'input_type'	=> 'text',
				'input_attr'	=> 'type="text" class="form-control" placeholder="Expired Date..."',
				'data_source'	=> '',
				'data_edit'		=> array(
					'db_process'	=> true,
				),

...
class Grouplayanans extends MY_Admin {
	private $_template 			= 'template_admin/main';
	private $_module_controller = 'backend_grouplayanans/grouplayanans/';
	private $_table_name 		= 'group_layanan';
	private $_table_field_pref 	= 'grolay_';
	private $_table_pk 			= 'grolay_id_group_layanan';
	private $_model_crud 		= 'grouplayanans_model';

	private $_page_title 		= 'Antrian : Admin Group Layanan';
	private $_page_content_info	= array(
		'title' => 'Data Admin Group Layanan',
	...
	private function get_show_column() {
		$column_list = array(
			array(
				...
				'field_name' 			=> $this->_table_field_pref . 'id_group_layanan',
				'show_no_static' 		=> true,
				'no_order'				=> 0,
			),
			array(
				'title_header_column' 	=> 'Nama Group',
				'field_name' 			=> $this->_table_field_pref . 'nama_group_layanan',
				'no_order'				=> 1,
			),
			array(
				'title_header_column' 	=> 'No Awal',
				'field_name' 			=> $this->_table_field_pref . 'no_awal',
				'no_order'				=> 2,
			),
			array(
				'title_header_column' 	=> 'Start No.',
				'field_name' 			=> $this->_table_field_pref . 'no_start',
				'no_order'				=> 3,
			),
			array(
				'title_header_column' 	=> 'End No.',
				'field_name' 			=> $this->_table_field_pref . 'no_end',
				'no_order'				=> 4,
			),
			array(
				'title_header_column' 	=> 'Jml. Tiket',
				'field_name' 			=> $this->_table_field_pref . 'jml_tiket',
				'no_order'				=> 5,
			),
			array(
	...
	private function get_input_field_new($data_value = array()) {
		$data_input = array(
			...
			array(
				'label' 		=> 'Nama Group Layanan',
				'db_field' 		=> $this->_table_field_pref . 'nama_group_layanan',
				'db_process'	=> true,
				'input_type'	=> 'text',
				'input_attr'	=> 'type="text" class="form-control" placeholder="Nama Group Layanan..."',
				'required'		=> 'required',
				'data_source'	=> '',
				'data_edit'		=> array(
					'db_process'	=> true,
			...
			array(
				'label' 		=> 'No Awal',
				'db_field' 		=> $this->_table_field_pref . 'no_awal',
				'db_process'	=> true,
				'input_type'	=> 'text',
				'input_attr'	=> 'type="text" class="form-control" placeholder="No Awal..."',
				'required'		=> 'required',
				'data_source'	=> '',
				'data_edit'		=> array(
					'db_process'	=> true,
			...
			array(
				'label' 		=> 'Start No',
				'db_field' 		=> $this->_table_field_pref . 'no_start',
				'db_process'	=> true,
				'input_type'	=> 'text',
				'input_attr'	=> 'type="text" class="form-control" placeholder="Start No..."',
				'required'		=> 'required',
				'data_source'	=> '',
				'data_edit'		=> array(
					'db_process'	=> true,
			...
			array(
				'label' 		=> 'End No',
				'db_field' 		=> $this->_table_field_pref . 'no_end',
				'db_process'	=> true,
				'input_type'	=> 'text',
				'input_attr'	=> 'type="text" class="form-control" placeholder="End No..."',
				'required'		=> 'required',
				'data_source'	=> '',
				'data_edit'		=> array(
					'db_process'	=> true,
			...
			array(
				'label' 		=> 'Jumlah Tiket',
				'db_field' 		=> $this->_table_field_pref . 'jml_tiket',
				'db_process'	=> true,
				'input_type'	=> 'text',
				'input_attr'	=> 'type="text" class="form-control" placeholder="Jumlah Tiket..."',
				'required'		=> 'required',
				'data_source'	=> '',
				'data_edit'		=> array(
					'db_process'	=> true,

...
class Lokets extends MY_Admin {
	private $_template 			= 'template_admin/main';
	private $_module_controller = 'backend_lokets/lokets/';
	private $_table_name 		= 'lokets';
	private $_table_field_pref 	= 'lokets_';
	private $_table_pk 			= 'lokets_id';
	private $_model_crud 		= 'lokets_model';

	private $_page_title 		= 'Antrian : Admin Loket';
	private $_page_content_info	= array(
		'title' => 'Data Admin Loket',
		'desc' 	=> 'List Loket',
	);
	...
	private function get_show_column() {
		$column_list = array(
			...
			array(
				'title_header_column' 	=> 'Loket Name',
				'field_name' 			=> $this->_table_field_pref . 'name',
				'no_order'				=> 1,
			),
			array(
				'title_header_column' 	=> 'Loket Type',
				'field_name' 			=> $this->_table_field_pref . 'type',
				'no_order'				=> 2,
			),
			array(
			...
			array(
				'title_header_column' 	=> 'IP Address',
				'field_name' 			=> $this->_table_field_pref . 'ip_address',
				'no_order'				=> 4,
			),
			array(
	...
	private function get_input_field_new($data_value = array()) {
		...
		$data_input = array(
			...
			array(
				'label' 		=> 'Group Loket',
				'db_field' 		=> $this->_table_field_pref . 'grolok_id',
				'db_process'	=> true,
				'input_type'	=> 'select',
	...
	function lists_ajax() {
		...
		$table 		.= ' LEFT JOIN ' . $this->db->dbprefix . 'grouplokets ON (lokets_grolok_id = grolok_id) ';

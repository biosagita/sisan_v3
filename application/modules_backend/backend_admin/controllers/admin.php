...
class Admin extends MY_Admin {
	...
	private function get_show_column() {
		$column_list = array(
			...
			array(
				'title_header_column' 	=> 'User Group',
				'field_name' 			=> 'usrgro_nama_user_group',
		        'no_order'				=> 3,
			),
			array(
	...
	private function get_input_field_new($data_value = array()) {
		...
		$this->load->model('usergroups_model','usergroupsx');
		$source_user_group = $this->usergroupsx->get_option();
		...
		$data_input = array(
			...
			array(
				...
				'db_process'	=> true,
				'input_type'	=> 'text',
				'input_attr'	=> 'type="text" data-parsley-minlength="4" class="form-control" placeholder="Username..."',
				'required'		=> 'required',
				'data_source'	=> '',
				'data_unique'	=> true,
				'data_edit'		=> array(
			...
			array(
				...
				'db_process'	=> true,
				'input_type'	=> 'password',
				'input_attr'	=> 'type="password" data-parsley-minlength="4" class="form-control" placeholder="Password..."',
				'required'		=> 'required',
				'data_source'	=> '',
				'data_md5'		=> true,
				'data_edit'		=> array(
			...
			array(
				...
				'db_process'	=> false,
				'input_type'	=> 'password',
				'input_attr'	=> 'type="password" data-parsley-minlength="4" class="form-control" placeholder="Re-password..." data-parsley-equalto="#admusr_userpasswd"',
				'required'		=> 'required',
				'data_source'	=> '',
	...
	function lists_ajax() {
		...
		$table 		.= ' LEFT JOIN ' . $this->db->dbprefix . 'user_group ON (admusr_usrgro_id = usrgro_id) ';

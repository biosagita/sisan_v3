...
class Permasalahan extends MY_Admin {
	private $_template 			= 'template_admin/main';
	private $_module_controller = 'backend_permasalahan/permasalahan/';
	private $_table_name 		= 'permasalahan';
	private $_table_field_pref 	= 'perm_';
	private $_table_pk 			= 'perm_id';
	private $_model_crud 		= 'permasalahan_model';

	private $_page_title 		= 'Antrian : Admin Permasalahan';
	private $_page_content_info	= array(
		'title' => 'Data Permasalahan',
		'desc' 	=> 'List Permasalahan',
	);
	...
	private function get_input_field_new($data_value = array()) {
		...
		$data_input = array(
			...
			array(
				...
				'db_process'	=> true,
				'input_type'	=> 'select',
				'input_attr'	=> 'type="text" class="form-control" placeholder="Layanan..."',
	...
	function lists_ajax() {
        ...
        $table 		.= ' LEFT JOIN ' . $this->db->dbprefix . 'layanan ON (perm_id_layanan = lay_id_layanan) ';

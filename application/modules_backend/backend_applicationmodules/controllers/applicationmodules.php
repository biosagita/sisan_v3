...
class Applicationmodules extends MY_Admin {
	private $_template 			= 'template_admin/main';
	private $_module_controller = 'backend_applicationmodules/applicationmodules/';
	private $_table_name 		= 'applicationmodules';
	private $_table_field_pref 	= 'appmod_';
	private $_table_pk 			= 'appmod_id';
	private $_model_crud 		= 'applicationmodules_model';

	private $_page_title 		= 'Antrian : Admin Application Modules';
	private $_page_content_info	= array(
		'title' => 'Data Admin Application Modules',
		'desc' 	=> 'List application modules',
	);
	...
	private function get_show_column() {
		$column_list = array(
			...
			array(
				'title_header_column' 	=> 'Module Name',
				'field_name' 			=> $this->_table_field_pref . 'name',
				'no_order'				=> 1,
			),
			array(
				'title_header_column' 	=> 'Module Link',
				'field_name' 			=> $this->_table_field_pref . 'link',
				'no_order'				=> 2,
			),
			array(
				'title_header_column' 	=> 'Module Type',
	...
	private function get_input_field_new($data_value = array()) {
		...
		$data_input = array(
			...
			array(
				...
				'required'		=> 'required',
				'data_source'	=> $source_module_type,
				'data_edit'		=> array(
					'required'			=> 'required',
					'db_process'		=> true,
				),

                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        ...
                        <?php elseif($val['input_type'] == 'checkbox') : ?>
                            <input type="checkbox" name="<?php echo $val['db_field']; ?>" id="<?php echo $val['db_field']; ?>" <?php echo $val['input_attr']; ?> <?php echo (!empty($val['data_edit']['required']) ? $val['data_edit']['required'] : ''); ?> <?php echo (!empty($val['data_edit']['input_disabled']) ? $val['data_edit']['input_disabled'] : ''); ?> value="1" <?php echo (in_array($val['data_edit']['input_value'], array('1', 'y')) ? 'checked' : ''); ?> />
                        <?php else : ?>

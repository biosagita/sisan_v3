...
class Callers extends MY_Admin {
	private $_template 			= 'template_admin/main';
	private $_module_controller = 'backend_callers/callers/';
	private $_table_name 		= 'callers';
	private $_table_field_pref 	= 'call_';
	private $_table_pk 			= 'call_id';
	private $_model_crud 		= 'callers_model';

	private $_page_title 		= 'Antrian : Admin Caller';
	...
	private function get_show_column() {
		$column_list = array(
			...
			array(
				'title_header_column' 	=> 'Address Caller',
				'field_name' 			=> $this->_table_field_pref . 'address',
				'no_order'				=> 1,
			),
			array(
			...
			array(
				'title_header_column' 	=> 'Status Off',
				'field_name' 			=> $this->_table_field_pref . 'status_off',
				'no_order'				=> 3,
	...
	private function get_input_field_new($data_value = array()) {
		...
		$data_input = array(
			...
			array(
				...
				'db_field' 		=> $this->_table_field_pref . 'address',
				'db_process'	=> true,
				'input_type'	=> 'text',
				'input_attr'	=> 'type="text" data-parsley-minlength="1" class="form-control" placeholder="Caller Address..."',
				'required'		=> 'required',
				'data_source'	=> '',
				'data_edit'		=> array(
					'db_process'	=> true,
			...
			array(
				'label' 		=> 'Loket Name',
				'db_field' 		=> $this->_table_field_pref . 'lokets_id',
				'db_process'	=> true,
				'input_type'	=> 'select',
			...
			array(
				'label' 		=> 'Status Off',
				'db_field' 		=> $this->_table_field_pref . 'status_off',
				'db_process'	=> true,
				'input_type'	=> 'checkbox',
				'input_attr'	=> '',
				'data_source'	=> '',
	...
	function lists_ajax() {
		...
		$table 		.= ' LEFT JOIN ' . $this->db->dbprefix . 'lokets ON (call_lokets_id = lokets_id) ';

...
class Companyprofile extends MY_Admin {
	...
	private $_table_field_pref 	= 'comprf_';
	private $_table_pk 			= 'comprf_id';
	private $_model_crud 		= 'companyprofile_model';

	private $_page_title 		= 'Antrian : Admin Company Profile';
	private $_page_content_info	= array(
		'title' => 'Data Company Profile',
	...
	private function get_show_column() {
		$column_list = array(
			...
			array(
				'title_header_column' 	=> 'Company Name',
				'field_name' 			=> $this->_table_field_pref . 'name',
				'no_order'				=> 1,
			),
			array(
				'title_header_column' 	=> 'Address 1',
				'field_name' 			=> $this->_table_field_pref . 'address1',
				'no_order'				=> 2,
			),
			array(
				'title_header_column' 	=> 'Phone',
				'field_name' 			=> $this->_table_field_pref . 'phone',
				'no_order'				=> 3,
			),
			array(

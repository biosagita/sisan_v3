...
class Waktulayanans extends MY_Admin {
	private $_template 			= 'template_admin/main';
	private $_module_controller = 'backend_waktulayanans/waktulayanans/';
	private $_table_name 		= 'waktu_layanan';
	private $_table_field_pref 	= 'waklay_';
	private $_table_pk 			= 'waklay_id_waktu_layanan';
	private $_model_crud 		= 'waktulayanans_model';

	private $_page_title 		= 'Antrian : Admin Waktu Layanan';
	private $_page_content_info	= array(
		'title' => 'Data Waktu Layanan',
		'desc' 	=> 'List waktu layanan',
	);
	...
	private function get_show_column() {
		$column_list = array(
			array(
				...
				'field_name' 			=> $this->_table_field_pref . 'id_waktu_layanan',
				'show_no_static' 		=> true,
				'no_order'				=> 0,
			),
			array(
				'title_header_column' 	=> 'Waktu Awal 1',
				'field_name' 			=> $this->_table_field_pref . 'waktu_awal_1',
				'no_order'				=> 1,
			),
			array(
				'title_header_column' 	=> 'Waktu Akhir 1',
				'field_name' 			=> $this->_table_field_pref . 'waktu_akhir_1',
				'no_order'				=> 2,
			),
			array(
				'title_header_column' 	=> 'Waktu Awal 2',
				'field_name' 			=> $this->_table_field_pref . 'waktu_awal_2',
				'no_order'				=> 3,
			),
			array(
				'title_header_column' 	=> 'Waktu Akhir 2',
				'field_name' 			=> $this->_table_field_pref . 'waktu_akhir_2',
				'no_order'				=> 4,
			),
			array(
				'title_header_column' 	=> 'Waktu Awal 3',
				'field_name' 			=> $this->_table_field_pref . 'waktu_awal_3',
				'no_order'				=> 5,
			),
			array(
				'title_header_column' 	=> 'Waktu Akhir 3',
				'field_name' 			=> $this->_table_field_pref . 'waktu_akhir_3',
				'no_order'				=> 6,
			),
			array(
				'title_header_column' 	=> 'Waktu Keterangan',
				'field_name' 			=> $this->_table_field_pref . 'keterangan',
				'no_order'				=> 7,
			),
			array(
	...
	private function get_input_field_new($data_value = array()) {
		$data_input = array(
			...
			array(
				'label' 		=> 'Waktu Awal 1',
				'db_field' 		=> $this->_table_field_pref . 'waktu_awal_1',
				'db_process'	=> true,
				'input_type'	=> 'text',
				'input_attr'	=> 'type="text" class="form-control" placeholder="Waktu Awal 1..."',
				'data_source'	=> '',
				'required'		=> 'required',
				'data_edit'		=> array(
					'db_process'	=> true,
			...
			array(
				'label' 		=> 'Waktu Akhir 1',
				'db_field' 		=> $this->_table_field_pref . 'waktu_akhir_1',
				'db_process'	=> true,
				'input_type'	=> 'text',
				'input_attr'	=> 'type="text" class="form-control" placeholder="Waktu Akhir 1..."',
				'data_source'	=> '',
				'required'		=> 'required',
				'data_edit'		=> array(
					'db_process'	=> true,
			...
			array(
				'label' 		=> 'Waktu Awal 2',
				'db_field' 		=> $this->_table_field_pref . 'waktu_awal_2',
				'db_process'	=> true,
				'input_type'	=> 'text',
				'input_attr'	=> 'type="text" class="form-control" placeholder="Waktu Awal 2..."',
				'data_source'	=> '',
				'data_edit'		=> array(
					'db_process'	=> true,
				),
			...
			array(
				'label' 		=> 'Waktu Akhir 2',
				'db_field' 		=> $this->_table_field_pref . 'waktu_akhir_2',
				'db_process'	=> true,
				'input_type'	=> 'text',
				'input_attr'	=> 'type="text" class="form-control" placeholder="Waktu Akhir 2..."',
				'data_source'	=> '',
				'data_edit'		=> array(
					'db_process'	=> true,
				),
			...
			array(
				'label' 		=> 'Waktu Awal 3',
				'db_field' 		=> $this->_table_field_pref . 'waktu_awal_3',
				'db_process'	=> true,
				'input_type'	=> 'text',
				'input_attr'	=> 'type="text" class="form-control" placeholder="Waktu Awal 3..."',
				'data_source'	=> '',
				'data_edit'		=> array(
					'db_process'	=> true,
				),
			...
			array(
				'label' 		=> 'Waktu Akhir 3',
				'db_field' 		=> $this->_table_field_pref . 'waktu_akhir_3',
				'db_process'	=> true,
				'input_type'	=> 'text',
				'input_attr'	=> 'type="text" class="form-control" placeholder="Waktu Akhir 3..."',
				'data_source'	=> '',
				'data_edit'		=> array(
					'db_process'	=> true,
				),

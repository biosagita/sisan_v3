...
class Footers extends MY_Admin {
	private $_template 			= 'template_admin/main';
	private $_module_controller = 'backend_footers/footers/';
	private $_table_name 		= 'footer';
	private $_table_field_pref 	= 'footer_';
	...
	private function get_show_column() {
		$column_list = array(
			array(
				...
				'field_name' 			=> $this->_table_field_pref . 'id_footer',
				'show_no_static' 		=> true,
				'no_order'				=> 0,
			),
			array(
				'title_header_column' 	=> 'Footer',
				'field_name' 			=> $this->_table_field_pref . 'text_footer',
				'no_order'				=> 1,
			),
			array(
	...
	private function get_input_field_new($data_value = array()) {
		$data_input = array(
			array(
				'db_field' 		=> $this->_table_field_pref . 'id_footer',
				'db_pk' 		=> true,
				'db_process'	=> false,
				'data_edit'		=> array(
					'db_process'		=> false,
			...
			array(
				'label' 		=> 'Footer',
				'db_field' 		=> $this->_table_field_pref . 'text_footer',
				'db_process'	=> true,
				'input_type'	=> 'text',

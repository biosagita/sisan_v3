...
class Webcams extends MY_Admin {
	private $_template 			= 'template_admin/main';
	private $_module_controller = 'backend_webcams/webcams/';
	...
	private $_page_title 		= 'Antrian : Admin Group Loket';
	private $_page_content_info	= array(
		'title' => 'Data Webcam Transaksi',
		'desc' 	=> 'List Webcam Transaksi',
	);
	...
	private function get_show_column() {
		$column_list = array(
            ...
            array(
                'title_header_column' 	=> 'Transaski No',
                'field_name' 			=> 'trans_transaction_no',
                'no_order'				=> 3,
            ),
            array(
                'title_header_column' 	=> 'Nama Nasabah',
                'field_name' 			=> 'trans_nama_nasabah',
                'no_order'				=> 4,
            ),
            array(
                'title_header_column' 	=> 'Subject',
                'field_name' 			=> 'trans_subject',
                'no_order'				=> 5,
            ),
            array(
                'title_header_column' 	=> 'Officer',
                'field_name' 			=> 'trans_officer',
                'no_order'				=> 6,
            ),
            array(
	...
	private function get_input_field_new($data_value = array()) {
		$data_input = array(
			array(
				'db_field' 		=> $this->_table_field_pref . 'id_transaksi',
				'db_pk' 		=> true,
				'db_process'	=> false,
				'data_edit'		=> array(
					'db_process'		=> false,
			...
			array(
				'label' 		=> 'Transaksi No',
				'db_field' 		=> $this->_table_field_pref . 'transaction_no',
				'db_process'	=> true,
				'input_type'	=> 'text',
			...
			array(
				'label' 		=> 'Nama Nasabah',
				'db_field' 		=> $this->_table_field_pref . 'nama_nasabah',
				'db_process'	=> true,
				'input_type'	=> 'text',
				'input_attr'	=> 'type="text" data-parsley-minlength="1" class="form-control" placeholder="Name..."',
				'required'		=> 'required',
			...
			array(
				'label' 		=> 'Subject',
				'db_field' 		=> $this->_table_field_pref . 'subject',
				'db_process'	=> true,
				'input_type'	=> 'text',
				'input_attr'	=> 'type="text" data-parsley-minlength="1" class="form-control" placeholder="Name..."',
				'required'		=> 'required',

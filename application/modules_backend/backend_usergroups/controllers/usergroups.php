...
class Usergroups extends MY_Admin {
	private $_template 			= 'template_admin/main';
	private $_module_controller = 'backend_usergroups/usergroups/';
	private $_table_name 		= 'user_group';
	private $_table_field_pref 	= 'usrgro_';
	private $_table_pk 			= 'usrgro_id';
	private $_model_crud 		= 'usergroups_model';

	private $_page_title 		= 'Antrian : Admin User Group';
	private $_page_content_info	= array(
		'title' => 'Data User Group',
		'desc' 	=> 'List User Group',
	);
	...
	private function get_show_column() {
		$column_list = array(
			...
			array(
				'title_header_column' 	=> 'Name',
				'field_name' 			=> $this->_table_field_pref . 'nama_user_group',
				'no_order'				=> 1,
			),
			array(
	...
	private function get_input_field_new($data_value = array()) {
		$data_input = array(
			...
			array(
				'label' 		=> 'Name',
				'db_field' 		=> $this->_table_field_pref . 'nama_user_group',
				'db_process'	=> true,
				'input_type'	=> 'text',

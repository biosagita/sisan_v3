...
class Settings extends MY_Admin {
	...
	private $_module_controller = 'backend_settings/settings/';
	private $_table_name 		= 'setting';
	private $_table_field_pref 	= 'sett_';
	private $_table_pk 			= 'sett_id_setting';
	private $_model_crud 		= 'settings_model';
	...
	private function get_show_column() {
		$column_list = array(
			array(
				...
				'field_name' 			=> $this->_table_field_pref . 'id_setting',
				'show_no_static' 		=> true,
				'no_order'				=> 0,
			),
			array(
				'title_header_column' 	=> 'Nama Group',
				'field_name' 			=> $this->_table_field_pref . 'setting',
				'no_order'				=> 1,
			),
			array(
				'title_header_column' 	=> 'No Awal',
				'field_name' 			=> $this->_table_field_pref . 'nilai',
				'no_order'				=> 2,
			),
			array(
	...
	private function get_input_field_new($data_value = array()) {
		$data_input = array(
			array(
				'db_field' 		=> $this->_table_field_pref . 'id_setting',
				'db_pk' 		=> true,
				'db_process'	=> false,
				'data_edit'		=> array(
					'db_process'		=> false,
			...
			array(
				'label' 		=> 'Setting',
				'db_field' 		=> $this->_table_field_pref . 'setting',
				'db_process'	=> true,
				'input_type'	=> 'text',
				'input_attr'	=> 'type="text" class="form-control" placeholder="Setting..."',
				'required'		=> 'required',
				'data_source'	=> '',
				'data_edit'		=> array(
					'db_process'	=> true,
			...
			array(
				'label' 		=> 'Nilai',
				'db_field' 		=> $this->_table_field_pref . 'nilai',
				'db_process'	=> true,
				'input_type'	=> 'text',
				'input_attr'	=> 'type="text" class="form-control" placeholder="Nilai..."',
				'required'		=> 'required',
				'data_source'	=> '',
				'data_edit'		=> array(
					'db_process'	=> true,

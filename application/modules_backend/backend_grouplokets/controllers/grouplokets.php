...
class Grouplokets extends MY_Admin {
	private $_template 			= 'template_admin/main';
	private $_module_controller = 'backend_grouplokets/grouplokets/';
	private $_table_name 		= 'grouplokets';
	private $_table_field_pref 	= 'grolok_';
	private $_table_pk 			= 'grolok_id';
	private $_model_crud 		= 'grouplokets_model';

	private $_page_title 		= 'Antrian : Admin Group Loket';
	private $_page_content_info	= array(
		'title' => 'Data Admin Group Loket',
		'desc' 	=> 'List group loket',
	);

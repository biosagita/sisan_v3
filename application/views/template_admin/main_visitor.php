...
<head>
    ...
    <link rel="apple-touch-icon-precomposed" sizes="144x144"
          href="<?php echo $assets; ?>/images/icons/apple-touch-icon-144-precomposed.png">
    <link rel="apple-touch-icon-precomposed" sizes="114x114"
          href="<?php echo $assets; ?>/images/icons/apple-touch-icon-114-precomposed.png">
    <link rel="apple-touch-icon-precomposed" sizes="72x72"
          href="<?php echo $assets; ?>/images/icons/apple-touch-icon-72-precomposed.png">
    <link rel="apple-touch-icon-precomposed"
          href="<?php echo $assets; ?>/images/icons/apple-touch-icon-57-precomposed.png">
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo $assets; ?>/icons/elusive/elusive.css">
    <link rel="stylesheet" type="text/css" href="<?php echo $assets; ?>/icons/typicons/typicons.css">
    ...
    <link rel="stylesheet" type="text/css"
          href="<?php echo $assets; ?>/widgets/summernote-wysiwyg/summernote-wysiwyg.css">
...
<div id="sb-site">
    ...
    <div id="page-wrapper">
        <div id="page-header" class="bg-gradient-9">
            <?php $this->load->view('template_admin/header_visitor'); ?>
        </div>
    ...
    <?php $this->load->view('template_admin/footer_visitor.php'); ?>
</div>
</body>
</html>
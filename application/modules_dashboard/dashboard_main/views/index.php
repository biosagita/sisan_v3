<style type="text/css">
    .box_loket{border:1px solid;text-align:center;min-height:80px;padding-top:5px;}
    .info_number{font-size: 40px;}
    .satu{background: <?php echo (!empty($warna_box[0]['sett_nilai']) ? $warna_box[0]['sett_nilai'] : '#3498db'); ?>;color: #fff;}
    .dua{background: <?php echo (!empty($warna_box[0]['sett_nilai']) ? $warna_box[0]['sett_nilai'] : '#3498db'); ?>;color: #fff;}
</style>

...
class Callers_model extends CI_Model {
	...
	function get_login(){
		return $this->db->get('callers')->row_array();
	}
	
	function get_all(){
		return $this->db->get('callers')->result_array();
	}
	
	function posts($data){
		return $this->db->insert('callers', $data);
	}
	
	function puts($data){
		return $this->db->update('callers', $data);
	}
	
	function delete($data){
		return $this->db->delete('callers', $data);
	}

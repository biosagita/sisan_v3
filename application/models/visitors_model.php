...
class Visitors_model extends CI_Model {
	...
	function get_login(){
		return $this->db->get('master_profile')->row_array();
	}
	
	function get_all(){
		return $this->db->get('master_profile')->result_array();
	}
	...
	function puts($data){
		return $this->db->update('master_profile', $data);
	}
	
	function delete($data){
		return $this->db->delete('master_profile', $data);
	}
